...
var urlCloud =["http://54.83.2.110:8080/geoserver/wms", "http://54.83.2.133:8080/geoserver/wms"]
var urlHome = "http://maps.knaaptime.com:8080/geoserver/wms"
var urlArray = ["http://54.83.2.110:8080/geoserver/wms", "http://54.83.2.133:8080/geoserver/wms", "http://maps.knaaptime.com:8080/geoserver/wms"];
...
var boundaries = new OpenLayers.Layer.WMS("Policy Areas", urlHome, {
	layers: ["Priority Funding Areas"],
	transparent: true,
	'sphericalMercator': true,
	format: "image/png"
}, {
...
var demos = new OpenLayers.Layer.WMS("Demographics", urlCloud, {
	layers: ["Hispanic Population", "African American", "Poverty"],
	transparent: true,
	'sphericalMercator': true,
	format: "image/png"
}, {
...
var employment = new OpenLayers.Layer.WMS("Employment", urlArray, {
	layers: ["NCSG Employment Centers", "Firms by Size", "Health Facilities"],
	transparent: true,
	'sphericalMercator': true,
	format: "image/png"
}, {
...
var housing = new OpenLayers.Layer.WMS("Housing", urlCloud, {
	layers: ["Subsidized Housing", "Subsidized Housing to be Expired by 2020"],
	transparent: true,
	'sphericalMercator': true,
	format: "image/png"
}, {
...
var network = new OpenLayers.Layer.WMS("Transportation", urlCloud, {
	layers: ["WMATA Purple Line", "Transit Stations", "MARC Line", "Bus Lines"],
	transparent: true,
	'sphericalMercator': true,
	format: "image/png"
}, {
...
var commuteshed = new OpenLayers.Layer.WMS("Commute Sheds", urlCloud, {
	layers: ["Bethesda before PL", "Bethesda after PL", "Long Branch before PL", "Long Branch after PL", "Central Campus before PL", "Central Campus after PL", "M Square before PL", "M Square after PL", "New Carrollton before PL", "New Carrollton after PL", "Walk Bike Catchment"],
	transparent: true,
	'sphericalMercator': true,
	format: "image/png"
}, {
